...
const Aboutme = () => {
  return (
    <div name = 'aboutme' className='lg:h-screen md:h-screen w-full mx-auto'>
        <h1 className='text-3xl text-center lg:pt-28 lg:text-4xl font-bold yasiru pt-20'>About me</h1>

        <div className='lg:flex lg:p-24 justify-center text-gray-300 mt-8 lg:mt-0'>
          ...
          <div className='lg:ml-12 flex flex-col justify-between'>
            <h1 className='font-bold  lg:text-4xl text-2xl text-center lg:text-left mt-4 lg:mt-0'>Yasiru Deshan</h1>
            ...
            <h1 className='lg:mt-8 font-bold lg:text-2xl p-8 lg:p-0'>Education</h1>
